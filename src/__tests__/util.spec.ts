import { isEnum, isObject, isOptional, isOptionalBoolean, isOptionalString, isString, mergeDeep, sha256, stringifyToBase64url } from "../Util"

test("sha256", () => {
    expect(sha256("example", "hex")).toBe('50d858e0985ecc7f60418aaf0cc5ab587f42c2570a884095a9e8ccacd0f6545c')
    expect(sha256("example", "base64")).toBe('UNhY4JhezH9gQYqvDMWrWH9CwlcKiECVqejMrND2VFw=')
    expect(sha256("example", "base64url")).toBe('UNhY4JhezH9gQYqvDMWrWH9CwlcKiECVqejMrND2VFw')
    expect(sha256("example", "binary")).toBe(Buffer.from('UNhY4JhezH9gQYqvDMWrWH9CwlcKiECVqejMrND2VFw=', 'base64').toString("binary"))
})
